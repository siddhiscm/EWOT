    ...
    public void stagesTime(){
        switch (stateProgressBar.getCurrentStateNumber()) {
            ...
            case 2:
                ...
                mTimeLeftInMillis=10000;//4 minutes
                startTimer(mTimeLeftInMillis);
                TIME=mTimeLeftInMillis;
                result="0x00 0x01 0x00 0x00";
                byte[] convertedBytes1 = convertingTobyteArray(result);
                writeCharaValue(convertedBytes1);
            ...
            case 3:
              ...
              //  mTimeLeftInMillis1=mTimeLeftInMillis;
                ...
                mProgressBar.setProgress((int) this.mTimeLeftInMillis / 1000);
                result="0x01 0x00 0x00 0x00";
                byte[] convertedBytes3 = convertingTobyteArray(result);
                writeCharaValue(convertedBytes3);
                //startTimer(1001010);
                mProgressBar.setVisibility(View.VISIBLE);
                mButtonStartPause.setEnabled(false);
                mTextViewCountDown.setVisibility(View.VISIBLE);
...
//        displayTimeandDate();
        ...
        try {
            writeCharacteristic(mReadCharacteristic,
                    value);
    ...
    public void writeCharacteristic(BluetoothGattCharacteristic characteristic, byte[] byteArray){
        ...
        String serviceName = String.valueOf(SampleGattAttributes.lookup(characteristic.getService().getUuid(), serviceUUID));
        String characteristicUUID = characteristic.getUuid().toString();
        String characteristicName = String.valueOf(SampleGattAttributes.lookup(characteristic.getUuid(), characteristicUUID));
        ...
        if (mBluetoothAdapter == null || mGatt == null) {
           ...
           Log.i("Characteristics name",getResources().getString(R.string.about)+"["+serviceName+"|"+characteristicName+"]"+
                   getResources().getString(R.string.app_name)+getResources().getString(R.string.altitude)+"["+characteristicValue+"]");
