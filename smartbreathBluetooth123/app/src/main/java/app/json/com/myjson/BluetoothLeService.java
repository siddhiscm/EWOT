...
public class BluetoothLeService extends Service {
    ...
    private final BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
        ...
        public void writeCharacteristicGattDb(
            ...
            String serviceName = SampleGattAttributes.lookup(characteristic.getService().getUuid(), serviceUUID);

            String characteristicUUID = characteristic.getUuid().toString();
            String characteristicName = SampleGattAttributes.lookup(characteristic.getUuid(), characteristicUUID);
    ...
    public boolean connect(final String address) {
        ...
        bluetoothGatt.getConnectedDevices();
