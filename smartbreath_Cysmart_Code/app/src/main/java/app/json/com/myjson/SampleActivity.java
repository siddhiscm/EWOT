...
//                mSwitch.setTextColor(getResources().getColor(R.color.green));
            ...
            case 2:
                ...
                startTimer(mTimeLeftInMillis);
                String result1;
                result1="0x00 0x00 0x00 0x00";
                byte[] convertedBytes1 = Utils.convertingTobyteArray(result1);
            ...
            case 3:
                ...
                TIME=mTimeLeftInMillis;
                String result2;
                result2="0x00 0x00 0x00 0x00";
                byte[] convertedBytes2 = Utils.convertingTobyteArray(result2);
                writeCharaValue(convertedBytes2);
              //  mTimeLeftInMillis1=mTimeLeftInMillis;
                startTimer(mTimeLeftInMillis);
                mProgressBar.setMax((int) this.mTimeLeftInMillis / 1000);
                mProgressBar.setProgress((int) this.mTimeLeftInMillis / 1000);
